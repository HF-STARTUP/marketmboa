...
class AddonController extends BaseController
{
    ...
    function getDirectories(): array
    {
        ...
        foreach ($addonsFolders as $directory) {
            ...
            // Only real module directories. Guard against stray files (e.g. an
            // uploaded Builder.zip) whose path would traverse through a file and
            // trip open_basedir on restricted hosts.
            $modulePath = base_path('Modules/' . $directory);
            if (is_dir($modulePath) && file_exists($modulePath . '/Addon/info.php')) {
