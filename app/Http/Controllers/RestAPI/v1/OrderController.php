...
class OrderController extends Controller
{
    ...
    public function track_order(Request $request): JsonResponse
    {
        ...
        if (isset($orderExist)) {
            ...
            $courierShipment = deliveryPartnerTrackingInfo($orderExist);

            $details->map(function ($query) use ($courierShipment) {
                $query['courier_shipment'] = $courierShipment;
                $query['courier_tracking_url'] = $courierShipment['tracking_url'] ?? null;
