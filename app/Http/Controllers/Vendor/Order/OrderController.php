...
class OrderController extends BaseController
{
    ...
    public function getView(string|int $id, DeliveryCountryCodeService $service, OrderService $orderService): View|RedirectResponse
    {
        ...
        if ($order['order_type'] == 'default_type') {
            ...
            $courierPartnerAssigned = deliveryPartnerAssigned(order: $order);
            return view('vendor-views.order.order-details', compact('order', 'linkedOrders',
                ...
                'countryRestrictStatus','totalDelivered', 'zipRestrictStatus', 'countries', 'zipCodes', 'orderCount', 'previousOrder', 'nextOrder', 'allProductsList', 'isOrderEditable', 'orderProductsSession', 'editOrderSummary', 'orderEditPaymentHistory', 'courierPartnerAssigned'));
        } else {
