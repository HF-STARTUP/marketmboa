...
class UserProfileController extends Controller
{
    ...
    public function account_order_details_delivery_man_info(Request $request)
    {
        ...
        $deliveryPartnerShipment = deliveryPartnerShipment($order->id);

        return view(VIEW_FILE_NAMES['delivery_man_info'], compact('delivered_count', 'order', 'paymentGatewayList', 'cashOnDeliveryStatus', 'offlinePaymentMethods', 'offlinePaymentStatus', 'deliveryPartnerShipment'));
    }
    ...
    public function track_order_result(Request $request)
    {
        ...
        if (isset($orderExist)) {
            ...
            $deliveryPartnerTracking = deliveryPartnerTrackingInfo($orderExist);
