...
class Seller extends Authenticatable
{
    ...
    {
        return $this->hasManyThrough(Review::class, Product::class, 'user_id', 'product_id', 'id', 'id')
    ...
    protected static function boot(): void
    {
        ...
        static::deleted(function ($model) {
            ...
            // Remove the vendor's Builder storefront domain/config rows so a
            // deleted vendor can never resolve a live storefront (tenant_id =
            // seller id). Guarded: the Builder module and its table may not be
            // installed.
            if (Schema::hasTable('tenant_domain_configs')) {
                DB::table('tenant_domain_configs')->where('tenant_id', $model->id)->delete();
            }
        });
    }
