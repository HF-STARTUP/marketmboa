...
//        $data['color_image'] = $colorImage;
    ...
    public static function getHostBaseDomain(string $host): string
    {
        ...
        $secondLevelLabels = ['co', 'com', 'net', 'org', 'gov', 'edu', 'ac', 'go', 'or', 'ne', 'me', 'gen', 'gob',
            'gouv', 'mil', 'sch', 'web', 'nom', 'ltd', 'plc', 'asn', 'id', 'firm', 'ind', 'res'];
