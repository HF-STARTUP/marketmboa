...
--
-- Host: localhost:8889
-- Generation Time: Aug 11, 2026 at 05:34 AM
...
('070c766c-d777-11ed-96f4-0c7a158e4469', '2factor', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":\"data\",\"otp_template\":\"OTP1\"}', '{\"gateway\":\"2factor\",\"mode\":\"live\",\"status\":\"0\",\"api_key\":\"data\",\"otp_template\":\"OTP1\"}', 'sms_config', 'live', 0, NULL, '2026-08-11 05:33:34', NULL),
...
CREATE TABLE `ai_chat_messages` (
  ...
  `role` enum('user','assistant','tool') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'user',
...
CREATE TABLE `ai_chat_sessions` (
  ...
  `guest_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `ai_settings` (
  ...
  `customer_generate_limit` int NOT NULL DEFAULT '0',
  `customer_image_upload_limit` int NOT NULL DEFAULT '0',
...
CREATE TABLE `auction_bids` (
  `id` bigint UNSIGNED NOT NULL,
  `auction_product_id` int DEFAULT NULL,
  `user_id` int DEFAULT NULL,
  `bid_amount` decimal(40,20) DEFAULT '0.00000000000000000000',
  `is_auto_bid` tinyint(1) DEFAULT NULL,
  `is_withdraw_bid` tinyint NOT NULL DEFAULT '0',
  `is_rollback_bid` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `auction_bid_logs`
--
...
CREATE TABLE `auction_bid_logs` (
  ...
  `user_id` int DEFAULT NULL,
  `bid_amount` decimal(40,20) DEFAULT '0.00000000000000000000',
  `previous_highest_bid` decimal(40,20) DEFAULT '0.00000000000000000000',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `auction_commission_payments`
--

CREATE TABLE `auction_commission_payments` (
  `id` bigint UNSIGNED NOT NULL,
  `auction_product_id` bigint UNSIGNED DEFAULT NULL,
...
--
-- Table structure for table `auction_edit_histories`
--

CREATE TABLE `auction_edit_histories` (
  `id` bigint UNSIGNED NOT NULL,
  `auction_product_id` bigint UNSIGNED NOT NULL,
  `user_id` bigint UNSIGNED NOT NULL,
  `user_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `previous_user_id` bigint UNSIGNED DEFAULT NULL,
  `meta` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `auction_entry_fees`
--

CREATE TABLE `auction_entry_fees` (
  `id` bigint UNSIGNED NOT NULL,
  `auction_product_id` int DEFAULT NULL,
  `fee_amount` decimal(40,20) DEFAULT NULL,
...
CREATE TABLE `auction_notifications` (
  ...
  `sender_type` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `auction_participants` (
  ...
  `auction_product_id` int DEFAULT NULL,
  `user_id` int DEFAULT NULL,
  `entry_fee_paid_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unpaid',
  `entry_fee_paid_amount` decimal(40,20) DEFAULT '0.00000000000000000000',
  `entry_fee_payment_method` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `entry_fee_payment_status` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `entry_fee_denied_note` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `auction_products` (
  ...
  `product_type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'physical',
  `item_condition` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `starting_price` decimal(40,20) NOT NULL DEFAULT '0.00000000000000000000',
  `minimum_increment_amount` decimal(40,20) NOT NULL DEFAULT '0.00000000000000000000',
  `maximum_decrement_amount` decimal(40,20) DEFAULT NULL,
  `shipping_fee` decimal(40,20) NOT NULL DEFAULT '0.00000000000000000000',
  `return_policy` text COLLATE utf8mb4_unicode_ci,
  `thumbnail` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thumbnail_storage_type` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'public',
  `images` text COLLATE utf8mb4_unicode_ci,
  `video_provider` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `youtube_video_url` text COLLATE utf8mb4_unicode_ci,
  `custom_video_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `custom_video_url_storage_type` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'public',
  ...
  `admin_commission_given` tinyint(1) NOT NULL DEFAULT '0',
  `total_tax_amount` decimal(40,20) DEFAULT NULL,
  `tax_type` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `delivery_status` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shipping_address_id` bigint UNSIGNED DEFAULT NULL,
  `shipping_address_info` json DEFAULT NULL,
  `billing_address_id` bigint UNSIGNED DEFAULT NULL,
  `billing_address_info` json DEFAULT NULL,
  `billing_same_as_shipping` tinyint(1) NOT NULL DEFAULT '0',
  `claim_note` text COLLATE utf8mb4_unicode_ci,
  `tracking_url` text COLLATE utf8mb4_unicode_ci,
  `current_highest_bid_amount` decimal(40,20) NOT NULL DEFAULT '0.00000000000000000000',
  ...
  `is_relaunched` tinyint(1) NOT NULL DEFAULT '0',
  `relaunch_count` int UNSIGNED NOT NULL DEFAULT '0',
  `went_live_notified_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `auction_product_tag`
--

CREATE TABLE `auction_product_tag` (
  `id` bigint UNSIGNED NOT NULL,
  `auction_product_id` bigint UNSIGNED NOT NULL,
...
--
-- Table structure for table `auction_recent_views`
--

CREATE TABLE `auction_recent_views` (
  `id` bigint UNSIGNED NOT NULL,
  `auction_product_id` int DEFAULT NULL,
  `user_id` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `auction_saved_products`
--

CREATE TABLE `auction_saved_products` (
  `id` bigint UNSIGNED NOT NULL,
  `auction_product_id` bigint UNSIGNED NOT NULL,
  `user_id` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Table structure for table `auction_tags`
--
...
--
-- Table structure for table `auction_withdraws`
--

CREATE TABLE `auction_withdraws` (
  `id` bigint UNSIGNED NOT NULL,
  `owner_type` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `owner_id` bigint UNSIGNED DEFAULT NULL,
  `auction_product_id` bigint UNSIGNED DEFAULT NULL,
  `amount` decimal(40,20) DEFAULT NULL,
  `commission_amount` decimal(40,20) DEFAULT NULL,
  `withdrawal_method_id` bigint UNSIGNED DEFAULT NULL,
  `withdrawal_method_fields` json DEFAULT NULL,
...
--
-- Table structure for table `builder_setups`
--

CREATE TABLE `builder_setups` (
  `id` bigint UNSIGNED NOT NULL,
  `tenant_id` bigint UNSIGNED DEFAULT NULL,
  `sub_tenant_id` bigint UNSIGNED DEFAULT NULL,
  `theme` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default',
  `group` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'layout-setup, home-page-setup, about-us-page-setup, etc.',
  `key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `value_type` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'string' COMMENT 'string, boolean, integer, array, json',
...
(18, 'colors', '{\"primary\":\"#1b7fed\",\"secondary\":\"black\",\"primary_light\":\"#CFDFFB\"}', '2020-10-11 13:53:02', '2026-08-11 05:33:34'),
...
(49, 'social_login', '[{\"login_medium\":\"google\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1},{\"login_medium\":\"facebook\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1}]', NULL, '2026-08-11 05:33:34'),
...
(104, 'apple_login', '[{\"login_medium\":\"apple\",\"client_id\":\"\",\"client_secret\":\"\",\"status\":1,\"team_id\":\"\",\"key_id\":\"\",\"service_file\":\"\",\"redirect_url\":\"\"}]', NULL, '2026-08-11 05:33:34'),
...
(176, 'firebase_otp_verification', '{\"status\":0,\"web_api_key\":\"\"}', '2024-09-24 07:52:17', '2026-08-11 05:33:35'),
...
--
-- Table structure for table `courier_provider_addresses`
--

CREATE TABLE `courier_provider_addresses` (
  `id` bigint UNSIGNED NOT NULL,
  `owner_type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'platform',
  `owner_id` bigint UNSIGNED NOT NULL DEFAULT '0',
  `provider` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `environment` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `address_hash` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `remote_address_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Table structure for table `courier_provider_settings`
--
...
CREATE TABLE `courier_shipments` (
  ...
  `host_order_reference` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `payload` json DEFAULT NULL,
  `dispatch_details` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `courier_tracking_events` (
  `id` bigint UNSIGNED NOT NULL,
  `courier_shipment_id` bigint UNSIGNED NOT NULL,
...
--
-- Table structure for table `courier_webhook_logs`
--
...
--
-- Table structure for table `erp_api_tokens`
--

CREATE TABLE `erp_api_tokens` (
  `id` bigint UNSIGNED NOT NULL,
  `name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `webhook_last_dispatched_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, '::1', NULL, '2026-08-11 05:29:52', '2026-08-11 05:29:52'),
(3, '::1', NULL, '2026-08-11 05:32:04', '2026-08-11 05:32:04'),
(4, '::1', NULL, '2026-08-11 05:33:37', '2026-08-11 05:33:37');
...
(410, '2026_06_18_000001_create_ai_chat_sessions_table', 93),
(411, '2026_06_18_000002_create_ai_chat_messages_table', 93),
(412, '2026_06_25_000001_create_product_views_table', 93),
(413, '2026_06_25_000002_create_customer_searches_table', 93),
(414, '2026_06_25_000003_add_recommendation_activity_indexes', 93),
(415, '2026_06_28_000001_create_erp_api_tokens_table', 93),
(416, '2026_07_01_120000_modify_token_column_as_text_in_password_resets_table', 93),
(417, '2026_03_25_172950_create_auction_products_table', 94),
(418, '2026_03_29_051417_create_auction_participants_table', 94),
(419, '2026_03_29_051418_create_auction_bids_table', 94),
(420, '2026_03_29_051419_create_auction_bid_logs_table', 94),
(421, '2026_03_29_051420_create_auction_transactions_table', 94),
(422, '2026_03_29_051421_create_auction_notifications_table', 94),
(423, '2026_03_29_051422_create_auction_entry_fees_table', 94),
(424, '2026_03_29_051424_create_auction_withdraws_table', 94),
(425, '2026_03_29_051425_create_auction_recent_views_table', 94),
(426, '2026_04_07_100000_create_auction_edit_histories_table', 94),
(427, '2026_04_07_100001_create_auction_saved_products_table', 94),
(428, '2026_04_18_000000_create_builder_setups_table', 94),
(429, '2026_04_26_000000_create_auction_commission_payments_table', 94),
(430, '2026_04_30_165924_add_tenant_columns_to_builder_setups_table', 94),
(431, '2026_05_03_103501_create_tenant_domain_configs_table', 94),
(432, '2026_06_07_150719_add_previous_user_id_and_meta_to_auction_edit_histories', 94),
(433, '2026_06_07_160000_backfill_transaction_id_on_auction_transactions', 94),
(434, '2026_06_11_120000_create_auction_tags_table', 94),
(435, '2026_06_11_120001_create_auction_product_tag_table', 94),
(436, '2026_06_13_120000_rename_auction_translation_details_key_to_description', 94),
(437, '2026_07_19_100001_create_courier_provider_settings_table', 94),
(438, '2026_07_19_100002_create_courier_shipments_table', 94),
(439, '2026_07_19_100003_create_courier_tracking_events_table', 94),
(440, '2026_07_19_100004_create_courier_webhook_logs_table', 94),
(441, '2026_07_27_100005_create_courier_provider_addresses_table', 94),
(442, '2026_07_29_100006_add_owner_to_courier_provider_settings_table', 94),
(443, '2026_07_29_100007_add_owner_to_courier_shipments_table', 94),
(444, '2026_07_29_100008_add_owner_to_courier_provider_addresses_table', 94),
(445, '2026_08_08_100009_add_supersede_and_dispatch_details_to_courier_shipments_table', 94),
(446, '2026_08_10_100010_scope_courier_shipment_consignment_uniqueness', 94);
...
(7, 'customer', 'order_failed_message', 'Order fa Message', 0, '2023-10-30 11:02:55', '2026-08-11 05:33:34'),
...
CREATE TABLE `order_taxes` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `tax_for` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'tax_for_orders'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sellers` (
  ...
  `cm_firebase_token_web` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `tenant_domain_configs`
--

CREATE TABLE `tenant_domain_configs` (
  `id` bigint UNSIGNED NOT NULL,
  `tenant_id` bigint UNSIGNED DEFAULT NULL,
  `sub_tenant_id` bigint UNSIGNED DEFAULT NULL,
  `type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'sub-domain or custom-domain',
  `domain` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_connected` tinyint(1) NOT NULL DEFAULT '0',
  `is_primary` tinyint(1) NOT NULL DEFAULT '0',
  `website_visibility` tinyint(1) NOT NULL DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(0, 'Walk-In Customer', 'Walk-In', 'Customer', '000000000000', 'def.png', 'walking@customer.com', NULL, '', NULL, NULL, '2026-08-11 05:33:34', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, 'en');
...
CREATE TABLE `v2_sidebar_pins` (
  ...
  `user_id` bigint UNSIGNED NOT NULL,
  `pin_id` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `withdrawal_methods` (
  ...
  `vendor_status` tinyint NOT NULL DEFAULT '0',
  `customer_status` tinyint NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
ALTER TABLE `ai_chat_messages`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ai_chat_messages_session_id_created_at_index` (`session_id`,`created_at`);
...
ALTER TABLE `ai_chat_sessions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ai_chat_sessions_customer_id_last_activity_at_index` (`customer_id`,`last_activity_at`),
  ADD KEY `ai_chat_sessions_guest_id_last_activity_at_index` (`guest_id`,`last_activity_at`),
  ADD KEY `ai_chat_sessions_customer_id_index` (`customer_id`),
  ADD KEY `ai_chat_sessions_guest_id_index` (`guest_id`);
...
ALTER TABLE `auction_bids`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_bids_ranked` (`auction_product_id`,`is_withdraw_bid`,`bid_amount`,`id`),
  ADD KEY `idx_bids_claims` (`auction_product_id`,`is_withdraw_bid`,`claim_start_time`),
  ADD KEY `idx_bids_user` (`auction_product_id`,`user_id`,`is_withdraw_bid`),
  ADD KEY `idx_bids_user_rollback` (`auction_product_id`,`user_id`,`is_rollback_bid`);

--
-- Indexes for table `auction_bid_logs`
--
ALTER TABLE `auction_bid_logs`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `auction_commission_payments`
--
ALTER TABLE `auction_commission_payments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `acp_owner_status_idx` (`owner_type`,`owner_id`,`payment_status`),
  ADD KEY `auction_commission_payments_auction_product_id_index` (`auction_product_id`);

--
-- Indexes for table `auction_edit_histories`
--
ALTER TABLE `auction_edit_histories`
  ADD PRIMARY KEY (`id`),
  ADD KEY `auction_edit_histories_auction_product_id_index` (`auction_product_id`),
  ADD KEY `auction_edit_histories_user_id_index` (`user_id`),
  ADD KEY `auction_edit_histories_previous_user_id_index` (`previous_user_id`);

--
-- Indexes for table `auction_entry_fees`
--
ALTER TABLE `auction_entry_fees`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `auction_participants`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `auction_participants_product_user_unique` (`auction_product_id`,`user_id`);
...
ALTER TABLE `auction_products`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `auction_products_slug_unique` (`slug`),
  ADD KEY `auction_products_status_start_time_end_time_index` (`status`,`start_time`,`end_time`),
  ADD KEY `auction_products_approval_status_status_index` (`approval_status`,`status`),
  ADD KEY `auction_products_category_id_status_index` (`category_id`,`status`),
  ADD KEY `auction_products_owner_type_owner_id_status_index` (`owner_type`,`owner_id`,`status`),
  ADD KEY `auction_products_shop_id_status_index` (`shop_id`,`status`),
  ADD KEY `auction_products_winner_user_id_status_index` (`winner_user_id`,`status`),
  ADD KEY `auction_products_winner_user_id_delivery_status_index` (`winner_user_id`,`delivery_status`),
  ADD KEY `auction_products_owner_type_index` (`owner_type`),
  ADD KEY `auction_products_is_canceled_index` (`is_canceled`);

--
-- Indexes for table `auction_product_tag`
--
ALTER TABLE `auction_product_tag`
  ADD PRIMARY KEY (`id`),
  ADD KEY `auction_product_tag_auction_product_id_tag_id_index` (`auction_product_id`,`tag_id`);

--
-- Indexes for table `auction_recent_views`
--
ALTER TABLE `auction_recent_views`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `auction_saved_products`
--
ALTER TABLE `auction_saved_products`
  ADD PRIMARY KEY (`id`),
  ADD KEY `auction_saved_products_auction_product_id_index` (`auction_product_id`),
  ADD KEY `auction_saved_products_user_id_index` (`user_id`);

--
-- Indexes for table `auction_tags`
--
ALTER TABLE `auction_tags`
  ADD PRIMARY KEY (`id`),
  ADD KEY `auction_tags_tag_index` (`tag`);
...
ALTER TABLE `auction_transactions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_transactions_payment` (`auction_product_id`,`type`,`payment_status`),
  ADD KEY `idx_transactions_user_payment` (`auction_product_id`,`user_id`,`type`,`payment_status`);

--
-- Indexes for table `auction_withdraws`
--
ALTER TABLE `auction_withdraws`
  ADD PRIMARY KEY (`id`),
  ADD KEY `auction_withdraws_owner_type_owner_id_status_index` (`owner_type`,`owner_id`,`status`),
  ADD KEY `auction_withdraws_auction_product_id_index` (`auction_product_id`);
...
--
-- Indexes for table `builder_setups`
--
ALTER TABLE `builder_setups`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `builder_setups_scope_group_key_draft_unique` (`tenant_id`,`sub_tenant_id`,`group`,`key`,`is_draft`),
  ADD KEY `builder_setups_group_is_draft_index` (`group`,`is_draft`),
  ADD KEY `builder_setups_group_key_is_draft_index` (`group`,`key`,`is_draft`),
  ADD KEY `builder_setups_tenant_id_sub_tenant_id_index` (`tenant_id`,`sub_tenant_id`),
  ADD KEY `builder_setups_sub_tenant_id_group_is_draft_index` (`sub_tenant_id`,`group`,`is_draft`);
...
ALTER TABLE `carts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_carts_customer_product` (`customer_id`,`product_id`);
...
--
-- Indexes for table `courier_provider_addresses`
--
ALTER TABLE `courier_provider_addresses`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `courier_provider_addresses_lookup_unique` (`owner_type`,`owner_id`,`provider`,`environment`,`address_hash`),
  ADD KEY `courier_provider_addresses_provider_index` (`provider`);

--
-- Indexes for table `courier_provider_settings`
--
ALTER TABLE `courier_provider_settings`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `courier_provider_settings_owner_provider_unique` (`owner_type`,`owner_id`,`provider`),
  ADD KEY `courier_provider_settings_is_active_index` (`is_active`),
  ADD KEY `courier_provider_settings_owner_index` (`owner_type`,`owner_id`);

--
-- Indexes for table `courier_shipments`
--
ALTER TABLE `courier_shipments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `courier_shipments_provider_index` (`provider`),
  ADD KEY `courier_shipments_consignment_id_index` (`consignment_id`),
  ADD KEY `courier_shipments_host_order_reference_index` (`host_order_reference`),
  ADD KEY `courier_shipments_status_index` (`status`),
  ADD KEY `courier_shipments_owner_index` (`owner_type`,`owner_id`),
  ADD KEY `courier_shipments_superseded_at_index` (`superseded_at`),
  ADD KEY `courier_shipments_provider_consignment_id_index` (`provider`,`consignment_id`);

--
-- Indexes for table `courier_tracking_events`
--
ALTER TABLE `courier_tracking_events`
  ADD PRIMARY KEY (`id`),
  ADD KEY `courier_tracking_events_courier_shipment_id_foreign` (`courier_shipment_id`),
  ADD KEY `courier_tracking_events_status_index` (`status`);

--
-- Indexes for table `courier_webhook_logs`
--
ALTER TABLE `courier_webhook_logs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `courier_webhook_logs_provider_index` (`provider`),
  ADD KEY `courier_webhook_logs_consignment_id_index` (`consignment_id`);
...
ALTER TABLE `customer_searches`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `customer_searches_customer_id_keyword_unique` (`customer_id`,`keyword`),
  ADD KEY `customer_searches_customer_id_searched_at_index` (`customer_id`,`searched_at`);
...
--
-- Indexes for table `erp_api_tokens`
--
ALTER TABLE `erp_api_tokens`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `erp_api_tokens_api_key_unique` (`api_key`);
...
ALTER TABLE `product_views`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `product_views_customer_id_product_id_unique` (`customer_id`,`product_id`),
  ADD KEY `product_views_customer_id_index` (`customer_id`),
...
--
-- Indexes for table `tenant_domain_configs`
--
ALTER TABLE `tenant_domain_configs`
  ADD PRIMARY KEY (`id`),
  ADD KEY `tenant_domain_configs_tenant_id_sub_tenant_id_index` (`tenant_id`,`sub_tenant_id`);
...
--
-- AUTO_INCREMENT for table `auction_bid_logs`
--
ALTER TABLE `auction_bid_logs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `auction_commission_payments`
--
ALTER TABLE `auction_commission_payments`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `auction_edit_histories`
--
ALTER TABLE `auction_edit_histories`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `auction_entry_fees`
--
ALTER TABLE `auction_entry_fees`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `auction_products`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100001;

--
-- AUTO_INCREMENT for table `auction_product_tag`
--
ALTER TABLE `auction_product_tag`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `auction_recent_views`
--
ALTER TABLE `auction_recent_views`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `auction_saved_products`
--
ALTER TABLE `auction_saved_products`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `auction_tags`
--
ALTER TABLE `auction_tags`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `auction_withdraws`
--
ALTER TABLE `auction_withdraws`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `builder_setups`
--
ALTER TABLE `builder_setups`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `courier_provider_addresses`
--
ALTER TABLE `courier_provider_addresses`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `courier_provider_settings`
--
ALTER TABLE `courier_provider_settings`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `courier_shipments`
--
ALTER TABLE `courier_shipments`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `courier_tracking_events`
--
ALTER TABLE `courier_tracking_events`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `courier_webhook_logs`
--
ALTER TABLE `courier_webhook_logs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `erp_api_tokens`
--
ALTER TABLE `erp_api_tokens`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tenant_domain_configs`
--
ALTER TABLE `tenant_domain_configs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `courier_tracking_events`
--
ALTER TABLE `courier_tracking_events`
  ADD CONSTRAINT `courier_tracking_events_courier_shipment_id_foreign` FOREIGN KEY (`courier_shipment_id`) REFERENCES `courier_shipments` (`id`) ON DELETE CASCADE;
COMMIT;
