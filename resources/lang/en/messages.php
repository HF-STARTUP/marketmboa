...
return [
    ...
    "current_delivery_partner" => "By The 3rd Party Delivery Partner",
    "3rd_Party_Delivery_Partner" => "3rd Party Delivery Partner",
    "View_Tracking_History" => "View Tracking History",
    "Hide_Tracking_History" => "Hide Tracking History",
    "Loading" => "Loading",
    "Tracking_Number" => "Tracking Number",
    "Shipment_Status" => "Shipment Status",
    "Track_Shipment" => "Track Shipment",
    "Dispatched_On" => "Dispatched On",
    "No_delivery_partner_is_enabled_Enable_one_from_Courier_Configuration" => "No delivery partner is enabled. Enable one from Courier Configuration.",
    "This_order_already_has_a_delivery_man_assigned_Sending_it_to_a_delivery_partner_will_remove_that_assignment" => "This order already has a delivery man assigned. Sending it to a delivery partner will remove that assignment.",
    "Please_select_a_delivery_partner_first" => "Please select a delivery partner first.",
    "Could_not_load_options_from_the_delivery_partner" => "Could not load options from the delivery partner",
    "The_delivery_partner_did_not_return_any_options" => "The delivery partner did not return any options. Check its credentials in Courier Configuration.",
    "Order_already_paid_nothing_to_collect" => "Order already paid, nothing to collect",
    "Delivery_partner_settings_updated_successfully" => "Delivery partner settings updated successfully",
    "Your_own_store_or_warehouse_the_rider_collects_this_parcel_from" => "Your own store or warehouse the rider collects this parcel from. Leave it on the default to use the store set in Courier Configuration.",
    "Receivers_Name" => "Receiver's Name",
    "Receivers_Phone" => "Receiver's Phone",
    "Cash_to_Collect" => "Cash to Collect",
    "Amount_the_rider_collects_from_the_customer_Enter_0_if_the_order_is_already_paid" => "Amount the rider collects from the customer on delivery. Enter 0 if the order is already paid.",
    "House_road_and_landmark_the_rider_needs_to_find_the_customer" => "House, road and landmark the rider needs to find the customer.",
    "Delivery_City" => "Delivery City",
    "Delivery_Area" => "Delivery Area",
    "Delivery_Country" => "Delivery Country",
    "Delivery_Postal_Code" => "Delivery Postal Code",
    "The_ZIP_or_PIN_code_of_the_delivery_address" => "The ZIP or PIN code of the delivery address.",
    ...
    "Taken_from_the_customers_saved_delivery_location_when_there_is_one_Otherwise_open_Google_Maps_right_click_the_delivery_address_and_click_the_two_numbers_that_appear_The_first_one_is_the_latitude" => "Taken from the customer's saved delivery location when there is one. Otherwise open Google Maps, right-click the delivery address and click the two numbers that appear — the first one is the latitude.",
    "The_second_of_the_two_numbers_from_the_same_Google_Maps_click_The_rider_is_sent_to_this_exact_point" => "The second of the two numbers from the same Google Maps click. The rider is sent to this exact point.",
    "Pickup_Branch" => "Pickup Branch",
    "Delivery_Branch" => "Delivery Branch",
    "The_partners_branch_that_collects_this_parcel" => "The partner's branch that collects this parcel.",
    "The_partners_branch_nearest_to_the_customer" => "The partner's branch nearest to the customer.",
    "Delivery_Service" => "Delivery Service",
    "The_delivery_speed_or_vehicle_this_partner_uses_for_the_parcel" => "The delivery speed or vehicle this partner uses for the parcel.",
    "Parcel_Weight" => "Parcel Weight",
    "Number_of_Items" => "Number of Items",
    "Parcel_Contents" => "Parcel Contents",
    "Printed_on_the_shipping_label_so_the_rider_knows_what_is_being_carried" => "Printed on the shipping label so the rider knows what is being carried.",
