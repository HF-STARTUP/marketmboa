                            ...
                            <div class="d-flex flex-column gap-2">
                                ...
                                <div class="d-flex gap-3 align-items-center mt-1">
                                    ...
                                    @if($orderDetails['payment_status']=="paid")
                                        <span
                                            class="text-center badge text-success border-success-1 text-bg-success rounded-1 fw-normal fs-12 bg-opacity-10">
                                        {{ translate('paid') }}
                                    </span>
                                    @else
                                        <span
                        ...
                        <div class="text-center mt-4 pb-2">
                                    ...
                                    <address class="mb-0">
                                        @if($deliveryPartnerTracking['delivery_partner'])
                                            <dl class="mb-0 flexible-grid sm-down-1 width--15">
                                                <dt>{{translate('current_delivery_partner')}}</dt>
                                                <dd class="text-capitalize">{{$deliveryPartnerTracking['delivery_partner']}}</dd>
                                            </dl>
                                        @endif
                                        @if($deliveryPartnerTracking['tracking_number'])
                                            <dl class="mb-0 flexible-grid sm-down-1 width--15">
                                                <dt>{{translate('Tracking_Number')}}</dt>
                                                <dd>{{$deliveryPartnerTracking['tracking_number']}}</dd>
                                            </dl>
                                        @endif
                                        @if($deliveryPartnerTracking['shipment_status'])
                                            <dl class="mb-0 flexible-grid sm-down-1 width--15">
                                                <dt>{{translate('Shipment_Status')}}</dt>
                                                <dd class="text-capitalize">{{translate($deliveryPartnerTracking['shipment_status_label'])}}</dd>
                                            </dl>
                                        @endif
                                    </address>
                                    <div class="fs-12 opacity-75 mt-2">
                            ...
                            <div class="d-flex flex-wrap justify-content-center gap-2">
                                ...
                                @if(!empty($deliveryPartnerTracking['tracking_url']))
                                    <a class="btn btn-outline-primary" href="{{ $deliveryPartnerTracking['tracking_url'] }}"
                                       target="_blank" rel="noopener">
                                        <span class="media-body text-nowrap">{{translate('track_with_delivery_partner')}}</span>
                                    </a>
                                @endif
                            </div>
                        </div>
