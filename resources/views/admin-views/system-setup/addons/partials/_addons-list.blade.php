                        ...
                        <div
                            ...
                            <div class="card-body rounded-0 p-0">
                                <div class="ratio-3-2 border">
                                    @if(is_file(base_path('public/'.$addon.'/module-assets/thumbnail.png')))
                                        <img class="img-fit" alt=""
                                             src="{{ dynamicAsset(path: $addon.'/module-assets/thumbnail.png') }}">
                                    @elseif(is_file(base_path('public/'.$addon.'/public/thumbnail.png')))
                                        <img class="img-fit" alt=""
                                             src="{{ dynamicAsset(path: $addon.'/public/thumbnail.png') }}">
                                    @elseif(isset($addonData['module_name']))
                                        <img class="img-fit" alt=""
