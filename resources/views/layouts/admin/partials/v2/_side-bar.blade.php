        ...
        <div class="v2-ctx-section" data-section="settings">
            ...
            @if (Helpers::module_permission_check('3rd_party_setup'))
                <div class="v2-ctx-group">
                    ...
                    @if (Route::has('admin.courier.config.index'))
                        <a class="v2-nav-item {{ Request::is('admin/courier*') ? 'v2-is-active' : '' }}" data-item="courier" href="{{ route('admin.courier.config.index') }}">
                            <span class="v2-nav-btn"><span class="v2-nav-label">{{ translate('3rd_Party_Delivery_Partner') }}</span></span>
                            <div class="v2-nav-right"><button class="v2-pin-btn" type="button" data-pin="courier" aria-label="Pin"></button></div>
                        </a>
                    @endif
                </div>
            @endif
