...
<div id="sidebarMain" class="d-none">
    ...
    $query->where('seller_is', 'seller')->where('seller_id', auth('seller')->id());
                        ...
                        @if (vendorDeliveryPartnerSetupAvailable())
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('vendor/courier/config*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                    href="{{ route('vendor.courier.config.index') }}"
                                    title="{{ translate('3rd_Party_Delivery_Partner') }}">
                                    <i class="tio-truck nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate text-capitalize">
                                        {{ translate('3rd_Party_Delivery_Partner') }}
                                    </span>
                                </a>
                            </li>
                        @endif
