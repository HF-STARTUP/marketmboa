...
<aside class="v2-ctxpanel" id="v2-ctxpanel">
    ...
    <div class="v2-ctx-section" data-section="settings">
        ...
        <div class="v2-ctx-group">
            ...
            @if (vendorDeliveryPartnerSetupAvailable())
                <a class="v2-nav-item {{ Request::is('vendor/courier/config*') ? 'v2-is-active' : '' }}" data-item="v-courier" href="{{ route('vendor.courier.config.index') }}">
                    <span class="v2-nav-btn"><span class="v2-nav-label">{{ translate('3rd_Party_Delivery_Partner') }}</span></span>
                    <div class="v2-nav-right"><button class="v2-pin-btn" type="button" data-pin="v-courier" aria-label="Pin"></button></div>
                </a>
            @endif
